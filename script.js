...
// const nztaTimestamp = new Date(data.lastUpdated * 1000); // Epoch to milliseconds
...
//       // console.log("NZTA EventType:", props.EventType);
...
//       } else if (item.geometry && Array.isArray(item.geometry.coordinates)) {
//         lng = item.geometry.coordinates[0];
//         lat = item.geometry.coordinates[1];
//       }

//       // Final hard check before trying to use the coords
...
//       // console.log("Matched icon type:", iconType);
...
// NEXT TO FIX
// NZTA HAS LINESTRING AND MAYBE POLYGON?
// BUT THESE ARE NOT SHOWING ON THE UNIFIED MAP YET
